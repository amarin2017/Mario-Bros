...
//    floor.close();
    ...
    while (!g.getQuit()) //loop goes forever until user puts exit
    {
        ...
        for (int col=100; col < sizey1; col++)
        {
        ...
        //setting boundaries
        if (rectPosX == 370 && rectPosY >= 0 && rectPosY <= 190)
        {
            rectPosX = 436;
        }
        
        if (rectPosX == 330 && rectPosY >= 0 && rectPosY <= 190)
        {
            rectPosX = 328;
        }
...
//
    ...
    //////////////////////////////
        ...
        //boundaries
        if (rectPosX == 290 && rectPosY >= 200 && rectPosY <= 430)
        {
            rectPosX = 436;
        }
        
        if (rectPosX == 270 && rectPosY >= 200 && rectPosY <= 430)
        {
            rectPosX = 268;
        }
